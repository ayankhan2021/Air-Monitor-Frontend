    ...
    return (
        <Paper sx={{ p: 3 }}>
            ...
            <Alert severity="info" sx={{ my: 2 }}>
                If the regular upload isn't working, try this direct form below.
            </Alert>

            <Paper sx={{ p: 3, bgcolor: 'rgba(0,0,0,0.1)', mt: 2 }}>
                <Typography variant="subtitle1" gutterBottom>Direct Form Upload</Typography>
                <form
